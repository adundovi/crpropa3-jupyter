...
corr_lenght_finite_with_grid_size = lambda n, Lbo, Lmax, N: corr_lenght_finite(
    n, Lbo, Lmax, 2 * Lmax / N
)


def corr_length_exact(n: "spectral index", Lbo: "bendover scale") -> float:
    return (
        8
        * np.sqrt(np.pi)
        * Lbo
